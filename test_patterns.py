...
SHOULD_MATCH = [
    ...
    "docker logs ces-agency-os-automation-1 --tail 500",
    "docker logs --tail=200 --since=1h ces-agency-os-automation-1",
    "docker logs ces-agency-os-automation-1 --since='30 minutes ago'",
